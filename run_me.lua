...
if mode == "train" then
    ...
    --trainTarget_path = "./voc_data/voc2007_trainval.t7"
    --trainName_path   = "./voc_data/voc2007_trainval.t7"
...
if mode == "test" then
    ...
    testTarget_path  = "./voc_data/voc2007_test.t7"
    testName_path    = "./voc_data/voc2007_test.t7"
